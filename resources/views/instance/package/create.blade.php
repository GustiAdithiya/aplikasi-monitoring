...
<div class="content">
    ...
    <div class="row">
        <form action="{{route('instance.package.store')}}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation">
            {{ csrf_field() }}
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <input name="code" type="text" class="form-control" id="code" require placeholder="Kode Paket" value="{{old('code')}}">
                                @if ($errors->has('code'))
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <textarea name="desc" placeholder="Deskripsi" require class="form-control" id="desc">{{old('desc')}}</textarea>
                                @if ($errors->has('desc'))
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                ...
                                <input name="start_at" type="datetime-local" class="form-control" require id="start_at" value="{{old('start_at')}}">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input name="finish_at" type="datetime-local" class="form-control" require id="finish_at" value="{{old('finish_at')}}">
